...
// Thông số Flash STM32F103RCT6
#define FLASH_PAGE_SIZE 0x800        // 2KB mỗi Page
#define OTA_STORAGE_ADDR 0x0801D000  // Địa chỉ vùng OTA bạn đã chọn
#define FLAG_PAGE_ADDR 0x0803F800    // Page cuối cùng lưu Flag
...
public:
  ...
  bool downloadToFlash(uint32_t start_addr);
  void parseHexLine(char *line);
};
#endif